locals {
  cluster_name = "devo-developments"
  region       = "us-east-1"
...
locals {
  ...
  subnet_ids     = ["subnet-0d779831a200e94ec", "subnet-04145ffe285d9b5ec", "subnet-01ad8779961e72d6b", "subnet-0d71979fad63f30b1", "subnet-01da8ea28ec913a78", "subnet-070de0195cffae7b6"]
  node_subnet_ids = ["subnet-04145ffe285d9b5ec", "subnet-01ad8779961e72d6b"]
}
...
module "eks" {
  ...
  eks_managed_node_groups = {
    devo-developments-workers = {
      ...
      desired_size   = 2
      disk_size      = 100
      labels = { role = "devo-developments-workers", env = "production" }
    }
  }
